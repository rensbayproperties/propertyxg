...
function Template2() {
  ...
  return (
    <>
      <div className="w-full relative h-fit overflow-x-hidden bg-white">

        <div className="w-full h-fit  flex items-center justify-center px-3 sm:px-4">
          <div className="w-full sm:w-[95%] lg:w-[87%] h-full ">
            {/* Header */}
            <div className="w-full h-auto  flex flex-col md:flex-row md:items-center md:justify-between gap-3 mt-3 p-2">
              <h2 className="text-lg sm:text-xl md:text-2xl font-semibold">
                Najaro Homes-MN-Private Room Apartment Lekki
              </h2>

              <button
                onClick={() => setOpen(true)}
                className="w-fit h-fit p-2 flex justify-center items-center gap-2 bg-[#e5f0ff] rounded-md md:mr-3 self-start md:self-auto"
              >
            ...
            <div className="w-full">
              <ImageCarousel variant="double" />
            </div>

            {/* Main Content */}
            <div className="w-full h-fit grid grid-cols-1 lg:grid-cols-[65%_35%] gap-5 mt-5">
              {/* Left Section */}
              <div className="w-full  h-full max-sm:order-2">
                ...
                <div className="mt-6">
                  <AmenitiesSection variant="grid" amenities={campaigns} />
                </div>
              ...
              <div className="w-full flex flex-col gap-y-5 max-sm:order-1">
                ...
                <div className="card space-y-3">
                  ...
                  <p className="">
                    ...
                    features, and surroundings. discover the space, its flow,
                    and its unique details with a dedicated expert guiding you
                    through each highlight
                  </p>
