...
const PageWrap = ({ id }: { id: string }) => {
  ...
  const endPage = Math.min(
    ...
    agentDetails?.listings?.meta.totalPages,
  );
          ...
          <div className="flex-1 space-y-4 text-center md:text-left">
            ...
            <div className="bg-gray-50 rounded-lg px-3 py-3 border flex gap-2 w-fit mx-auto md:mx-0">
              <div className="flex flex-wrap items-center gap-2 text-xs font-semibold text-gray-800">
                ...
                <span className="flex items-center gap-2 bg-blue-50 text-blue-700 px-2 py-1 rounded-md">
                  <i className="bi bi-key"></i> Rent (
                  {agentDetails?.listingStats?.rent})
                </span>
                <span className="flex items-center gap-2 bg-green-50 text-green-700 px-2 py-1 rounded-md">
                  <i className="bi bi-house-check"></i> Sale (
                  {agentDetails?.listingStats?.sale})
                </span>
                <span className="flex items-center gap-2 bg-purple-50 text-purple-700 px-2 py-1 rounded-md">
        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-[70%_30%] gap-6">
            <div className="space-y-4">
              ...
              {agentDetails && agentDetails?.listings?.data?.length < 1 ? (
              ...
              <div className="flex items-center justify-center gap-2 py-3 flex-wrap">
                ...
                {endPage < agentDetails?.listings?.meta.totalPages && (
                  <button
                    onClick={() => setPageGroup((prev) => prev + 1)}
                    className="px-4 py-2 rounded-md border border-gray-200 bg-white text-gray-700 hover:bg-gray-50 transition"
                  >
